...
class OauthProvider(object):
    ...
    def userinfo_synapse_idp(self, token, userinfo_url):
        ...
        elif "3444324" in teams:
            userinfo[4] = "Liposarcoma Data Portal"
        elif "3446777" in teams:
            userinfo[4] = "Patnaik Lab-LSP Prostate Collaboration"
        elif "3446779" in teams:
            userinfo[4] = "Immune Profile - BWH LSP"
        elif "3446780" in teams:
            userinfo[4] = "LSP-Nanostring"
        elif "3446781" in teams:
            userinfo[4] = "LSP-RareCyte"
        elif "3448652" in teams:
            userinfo[4] = "Meningioma Project"
        elif "3449848" in teams:
            userinfo[4] = "Procode Data Portal"
        elif "3463332" in teams:
            userinfo[4] = "OncoLens"
        elif "3473161" in teams:
            userinfo[4] = "The House of Mouse"
        elif "3478237" in teams:
            userinfo[4] = "VUMC CRC SPORE"
        elif "3484566" in teams:
            userinfo[4] = "IDG"
        elif "3500978" in teams:
            userinfo[4] = "PitMap"
        elif "3514773" in teams:
        ...
        elif "3527802" in teams:
            userinfo[4] = "Kidney - UW"
        elif "3577176" in teams:
            userinfo[4] = "Paris Brain Initiative"
        elif "3584626" in teams:
            userinfo[4] = "Danaher HMS Ignition"
        elif "3586386" in teams:
            userinfo[4] = "P186 HS Spatial Profiling"
        else:
            userinfo[4] = "HTAN"
